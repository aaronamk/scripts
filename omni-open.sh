...
case "$ext" in
  "raw")  setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "png")  setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "jpg")  setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "jpeg") setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "gif")  setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "bmp")  setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "tiff") setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "tif") setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "webp") setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "heic") setsid nohup swayimg         "$1" >/dev/null 2>&1 & sleep 0.1 ;;
  "wav")  mpv                      "$1" ;;
  "flac") mpv                      "$1" ;;
  "opus") mpv                      "$1" ;;
  "ogg")  mpv                      "$1" ;;
